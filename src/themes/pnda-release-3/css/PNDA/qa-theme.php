...
class qa_html_theme extends qa_html_theme_base
{
	...
	private $welcome_widget_class = 'pnda';
...
*/
        ...
        $this->content['css_src'][] = $this->rooturl . 'qa-styles.css?';
	...
	public function nav_main_sub()
	{
		...
		/*
		$this->output('<div class="container-fluid qa-body-wrapper">' .
                      '    <div class="row">' .
                      '        <div class="container">');*/
		$this->qam_search();
	...
	public function header()
	{
        ...
        $this->output('<div class="container-fluid basic-page">');
        $this->output('    <div class="row">');
        $this->output('        <div class="sky">');
        $this->output('            <div class="container">');
        $this->output('                <div class="slide-overlay">');
        $this->output('                    <h2 class="title">Questions & Answers</h2>');
	...
	*/
	...
	{
		$this->output('<div class="col-xs-12 col-sm-12 col-md-12 qa-q-list-item'.rtrim(' '.@$q_item['classes']).'" '.@$q_item['tags'].'>');
	...
	{
		$this->output('<div class="qa-q-item-main col-xs-10 col-sm-9 col-md-10">');
	...
	{
		return
		    '<div class="container-fluid qa-body-wrapper">' .
            '    <div class="row">' .
            '        <div class="container">' .
