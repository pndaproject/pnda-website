...
// Direct-link key (to identify a direct link in the page's txt file)
Config::set('AM_KEY_DIRECT_LINK', 'direct-link');
Config::set('AM_KEY_DIRECT_LINK_TAB_NAME', 'direct-link-tab-name');
